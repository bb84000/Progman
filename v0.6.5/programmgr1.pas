...
begin
  ...
  begin
    AppState :=  SW_SHOWMAXIMIZED;                   // Application is nerver maximized, only the main form
  end else
  begin
  ...
  For i:= 0 to 5 do WState:=WState+IntToHex(WinPos[i], 4);
